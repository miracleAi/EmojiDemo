...
public class CustemEmojis {
    ...
    static {
        ...
        sXhsEmoticonHashMap.put("[白眼]", "xhsemoji_2.png");
        sXhsEmoticonHashMap.put("[瞎]", "xhsemoji_3.png");
        sXhsEmoticonHashMap.put("[酷]", "xhsemoji_4.png");
        sXhsEmoticonHashMap.put("[哭]", "xhsemoji_5.png");
        sXhsEmoticonHashMap.put("[萌]", "xhsemoji_6.png");
        sXhsEmoticonHashMap.put("[挖鼻孔]", "xhsemoji_7.png");
        sXhsEmoticonHashMap.put("[晕]", "xhsemoji_8.png");
        sXhsEmoticonHashMap.put("[好冷]", "xhsemoji_9.png");
        sXhsEmoticonHashMap.put("[哈哈]", "xhsemoji_10.png");
        sXhsEmoticonHashMap.put("[汗]", "xhsemoji_11.png");
        sXhsEmoticonHashMap.put("[么么哒]", "xhsemoji_12.png");
        sXhsEmoticonHashMap.put("[口水]", "xhsemoji_13.png");
        sXhsEmoticonHashMap.put("[好雷]", "xhsemoji_14.png");
        sXhsEmoticonHashMap.put("[啊]", "xhsemoji_15.png");
        sXhsEmoticonHashMap.put("[刺瞎]", "xhsemoji_16.png");
        sXhsEmoticonHashMap.put("[震惊]", "xhsemoji_17.png");
        sXhsEmoticonHashMap.put("[嘘]", "xhsemoji_18.png");
