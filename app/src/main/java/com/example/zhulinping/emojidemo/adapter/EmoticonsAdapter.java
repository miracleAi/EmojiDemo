...
public class EmoticonsAdapter<T> extends BaseAdapter {
    ...
    protected EmojiPageBean mEmoticonPageEntity;
    ...
    public EmoticonsAdapter(Context context, EmojiPageBean emoticonPageEntity, EmoticonClickListener onEmoticonClickListener) {
    ...
    private void checkDelBtn(EmojiPageBean entity) {
        EmojiPageBean.DelBtnStatus delBtnStatus = entity.getDelBtnStatus();
        if (EmojiPageBean.DelBtnStatus.GONE.equals(delBtnStatus)) {
            return;
        }
        if (EmojiPageBean.DelBtnStatus.FOLLOW.equals(delBtnStatus)) {
            mDelbtnPosition = getCount();
            mData.add(null);
        } else if (EmojiPageBean.DelBtnStatus.LAST.equals(delBtnStatus)) {
